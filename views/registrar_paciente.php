        ...
        <div class="row">
            ...
            <form>
                <div class="form-group col-md-4 col-md-offset-2">
                    ...
                    <input type="text" class="form-control" name="nro_historia" id="nro_historia" disabled="true">
                </div>
                <div class="form-group col-md-4">
                    <label for="ced_paciente">Cedula</label>
                    <input type="text" class="form-control" name="ced_paciente" id="ced_paciente" placeholder="cedula">
                </div>
                <div class="form-group col-md-4 col-md-offset-2">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="tipo_sangre" name="tipo_sangre" placeholder="Tipo de sangre">
                </div>
                <div class="form-group col-md-4 col-md-offset-2 ">
                    <label for="tel_movil">Telefono movil</label>
                    <input type="text" class="form-control" id="tel_movil" name="tel_movil" placeholder="04XX/0000000">
                </div>
                <div class="form-group col-md-4 ">
                    <label for="tel_casa">Password</label>
                    <input type="password" class="form-control" id="tel_casa" name="tel_casa" placeholder="04XX/0000000">
                </div>
                <div class="form-group col-md-8 col-md-offset-2 ">
                    <label for="Direccion">Direccion</label>
                    <textarea name="" id="direccion" name="direccion" class="form-control" rows="3" required="required"></textarea>
                </div>
                <center>
